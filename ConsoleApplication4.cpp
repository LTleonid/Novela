...
void start() {
    ...
    case 2:
        ...
        case 1:
            ...
            case 1:
                ...
                break;
            default:
                Screen_Dialog("Генерал Иванов", "Нужно говорить 'Так точно'. Приступить к работе, живо.", 15, 3);
                break;
            }
        default:
            break;
        ...
        Screen_Dialog(Name, "Благодарю вас, генерал. Я обязательно воспользуюсь вашим опытом, если что-то будет неясно.", 15, 3);
        Screen_Dialog("Генерал Иванов", "Отлично. Удачи вам, " + Name + ". Я уверен, что вы справитесь на отлично.", 15, 3);
        break;
    default:
        break;
    }
    ...
    //TODO: Код для еды
    if (cc == "Хлеб") {
        Screen_Text("По взращению домой вы съели весь хлеб, Дома кушать нечего но вы уже сытый");
        choice = Screen_Choice(vector <string> {"Пойти в магазин заново", "Пойти отдыхать"});
        switch (choice)
        {
        case 1:
            Screen_Dialog("Действия", "Вы не спеша одели куртку и вышли в магазин");
...
void Poland() {
    Screen_Dialog("Генерал Иванов", Name + ", появилась возможность. Польша уязвима. Нам нужно, чтобы вы возглавили атаку и завоевали её.", 15, 3);
    int choice = Screen_Choice(vector<string>{"Принять миссию.", "Отказаться."});
    switch (choice) {
    case 1:
        Screen_Dialog("Генерал Иванов", "Удачи, " + Name + ". Польша ждет вашего завоевания.", 15, 3);
        break;
    case 2:
        Screen_Dialog("Генерал Иванов", "Понятно, " + Name + ". Мы найдем другие пути.", 15, 3);
        break;
    default:
        break;
...
void Здравоумие_событие_отрицательное() {
    ...
    case 1:
        ...
        break;
    default:
        Screen_Dialog(Name, "Генерал, идите в пень!");
        break;
    }
    ...
    case 1:
        ...
        case 1:
            ...
            break;
        case 2:
            Screen_Dialog(Name, "Генерал, мне что-то нехорошо, у меня плохое самочувствие - дрожат руки и знаете, какое-то странное внутреннее беспокойство, как будто это паническая атака..");
            ...
            Screen_Dialog(Name, "Простите. Простите.. Я уже иду работать!");
            break;
        }
        break;
    case 2:
        ...
        Screen_Dialog(Name, "КАК ЖЕ Я УСТАЛ ОТ ВСЕХ ВАС! Я НЕ МОГУ БОЛЬШЕ ЭТО ТЕРПЕТЬ! Я ХОЧУ РАЗБИТЬ ТУТ ВСЁ! ВЫ ВСЕ ТВАРИ!");
        Screen_Dialog("Ваш коллега", "Ты чего? Что случилось? Что произошло? Прекрати!"); //Прописать про друга + Прописать про долги
        Screen_Dialog(Name, "Отвали");
        ...
        case 1:
            ...
            {
            case 1:
                Screen_Dialog(Name, "Добрый день, врач, мне сегодня стало плохо, у меня начали сильно дрожать руки, да так, что даже кружку с чаем пролил, потом я заметил, что чувствую какое-то странное ощущение, как будто какое-то внутреннее напряжение, затем я стал нервным, мне захотелось разбить всё вокруг и даже подраться.. Меня все вокруг бесят, а в первую очередь - мой генерал. А ещё я чувствую,что как будто перестаю себя контролировать под влиянием эмоций. ");
                ...
                Screen_Dialog(Name, "Пфффф, да какой нервный срыв, врач!? Вы о чём?)))");
                ...
                break;
            case 2:
                Screen_Dialog(Name, "Добрый день, врач, впринципе не всё так плохо, просто странное какое-то ощущение, руки дрожат, можете просто дать мне пожалуйста успокоительное?");
                Screen_Dialog("Врач", "Вы уверены, что всё хорошо? Мне ваш коллега уже рассказал о вашем нервном срыве и о том, что вы на эмоциях себя вели неадекватно");
                Screen_Dialog(Name, "НЕТ, НЕТ, НЕТ! Всё хорошо, правда, просто дайте мне пожалуйста немного успокоительного");
                Screen_Dialog("Врач", "Ну всё же, я пожалуй вас осмотрюяушал ваше сердцебиение, а затем резко и неожиданно ударил вас маленьким молотком по колену");
                Screen_Dialog(Name, "АААЙ! Больно!");
                Screen_Dialog("Система", "Вы вздрогнули и испугались");
                Screen_Dialog("Врач", "Всё понятно с вами. Зачем вы меня обманули?");
                break;
            }
            break;
        case 2:
