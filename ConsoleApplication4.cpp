...
void start() {
    ...
    Screen_Dialog("Генерал Иванов", "Добро пожаловать в команду, сынок. Меня зовут Генерал Иванов. Я вижу, что вы готовы к работе.");
    ...
    case 2:
        ...
        Screen_Dialog("Генерал Иванов", "Отлично. Удачи вам, сынок. Я уверен, что вы справитесь на отлично.");
        break; 
    default:
        break;
    }
...
void Здравоумие_событие_отрицательное() {
    ...
    int choice233 = Screen_Choice(arr12);
    switch (choice233)
    {
    case 1:
        ...
        vector <string> arr23{ "Извиниться перед генералом, ничего не объяснять и пойти работать", "Сказать генералу, что тебе становится плохо, попросить выходной" };
        int choice1 = Screen_Choice(arr23);
        switch (choice1)
        {
        case 1:
